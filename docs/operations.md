...
`plume-gfx-plot-mark` is centered on graphics work in Dart. The technical target is: Design a Dart verification harness for plot systems, covering resource planning, capacity fixtures, and failure-oriented tests.
...
The score is deterministic. The current threshold is 172. Risk has a penalty of 4, latency has a penalty of 2, and weight contributes a bonus of 5.
