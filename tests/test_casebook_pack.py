"""Regression checks for the plume-gfx-plot-mark casebook."""
...
from casebook.harness import assert_expected, plume_gfx_plot_mark_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(plume_gfx_plot_mark_summary(), assert_expected())
